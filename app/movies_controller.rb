...
def can_be_found_updated_and_saved
  ...
  Movie.create_with(title: 'Even Awesomer Flick').find_or_create_by(title: 'Even Awesomer Flick')
end

def can_update_using_update_method
  # Update movie title to "Wat, huh?"
  Movie.create(title: "Wat?")
  Movie.create_with(title: 'Wat?').find_or_create_by(title: 'Wat, huh?')
end
...
def can_update_multiple_items_at_once
  ...
  Movie.update_all(title: 'A Movie') do |u|
    u
  end
end
